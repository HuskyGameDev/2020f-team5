...
public class CameraControls : MonoBehaviour
{
    ...
    public CanvasScaler canvasScaler;           // Scaler of canvas camera renders to, used to access reference resolution for calculating aspect ratio of visible area
    ...
    void Start()
    {
        ...
        _heightvisible = 1 - (bottomUIPanel.rect.height + topUIPanel.rect.height) / canvasScaler.referenceResolution.y; // Proportion of height not covered by UI
        ...
        _visibleCenterOffset = _camera.orthographicSize * (1 - _heightvisible - (topUIPanel.rect.height * 2 / canvasScaler.referenceResolution.y)); // Distance between center of camera, and center of visible area in units. Same as area obstructed by UI
    ...
    void Update()
    {
        ...
        _visibleCenterOffset = _camera.orthographicSize * (1 - _heightvisible - (topUIPanel.rect.height * 2 / canvasScaler.referenceResolution.y));
